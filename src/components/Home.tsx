            ...
            {featuredIndianCars.map(car => {
              ...
              return (
                <div 
                  key={car.id} 
                  id={`featured-${car.id}`}
                  className="bg-white rounded-3xl overflow-hidden border border-gray-150/70 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-300 flex flex-col group relative"
                >
