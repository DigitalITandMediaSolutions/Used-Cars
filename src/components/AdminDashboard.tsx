...
export default function AdminDashboard({
  ...
  const [adminListings, setAdminListings] = useState<AdminListingItem[]>([
    { id: 'ul-1', brand: 'BMW', model: '330i M Sport', price: 33800, year: 2021, sellerName: 'Arthur Pendragon', sellerRole: 'Dealer', status: 'Approved', views: 742 },
    { id: 'ul-2', brand: 'Toyota', model: 'RAV4 Hybrid XLE', price: 25900, year: 2020, sellerName: 'Arthur Pendragon', sellerRole: 'Dealer', status: 'Approved', views: 589 },
    { id: 'flag-99', brand: 'Ferrari', model: '488 GTB Spyder', price: 1800, year: 2019, sellerName: 'Mordred Traitor', sellerRole: 'User', status: 'Flagged', views: 4015 }
  ]);
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
                  ...
                  <div className="bg-white border border-gray-150 rounded-2xl p-5 shadow-sm">
                    ...
                    <strong className="text-2.5xl font-black text-slate-950 font-mono block mt-1">${revenueTotal.toLocaleString()}</strong>
                  ...
                  {adminListings.map(listing => (
                    <div key={listing.id} className="border border-gray-150 rounded-2.5xl p-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                      <div>
                        ...
                        <span className="text-xs font-mono text-emerald-700 block mt-0.5">${listing.price.toLocaleString()}</span>
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-100 pb-4">
                  ...
                  <div className="bg-emerald-50 text-emerald-700 border border-emerald-200 px-4 py-2.5 rounded-2xl">
                    ...
                    <strong className="text-lg font-mono font-black">${revenueTotal.toLocaleString()}</strong>
                  </div>
                </div>
                    ...
                    <tbody className="divide-y divide-gray-100 font-mono">
                      {transactions.map(tx => (
                        <tr key={tx.id} className="hover:bg-slate-50/50">
                          ...
                          <td className="py-3.5 text-slate-950 font-bold">${tx.amount.toFixed(2)}</td>
